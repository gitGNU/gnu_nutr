...
#   psycopg2 seems to complain about this, but I can run it fine from within psql.
...
#    create table of nutrient data per 200 calories, rather than per 100 g
    ...
    output_file = open('nutrient_score.txt', 'w')
    for r in result:
        food_id = r[0]
        ...
        text = "%d^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f^%f" % \
            (food_id,
             nutr_dict[203],
             nutr_dict[204],
             nutr_dict[205],
