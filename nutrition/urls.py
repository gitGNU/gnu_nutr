...
urlpatterns = \
    patterns('',
             ...
             (r'create_recipe/recipe_id/(?P<recipe_id>\d+)/food_id/(?P<food_id>\d+)/$', create_recipe),
             (r'create_recipe/recipe_id/(?P<recipe_id>\d+)/$', create_recipe),
             ...
             (r'create_recipe/recipe_id/(?P<recipe_id>\d+)/add_ingredient/$', add_ingredient),
             ...
             (r'nutrient_search_result/(?P<food_group>\d+)/(?P<nutr1>\d+)/(?P<fact1>-{0,1}\d{1})/$', nutrient_search_result),
